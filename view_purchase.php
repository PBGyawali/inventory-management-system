...
//view_purchase.php
if(empty($_GET['purchase_id'])||empty($_GET["pdf"])){
...
elseif(isset($_GET["pdf"]) && isset($_GET['purchase_id']))
{
	...
	<table width="100%" border="1"  cellpadding="5" cellspacing="0">
		...
		<tr  >
			<td align="center" style="border-bottom:none;" colspan="2">
				<b style="font-size:32px;">'.ucwords($data["company_name"]).'</b>
				<br />
				<span style="font-size:16px;">'.$data["company_address"].'</span>
				<br />
				<span style="font-size:16px;"><b>Contact No. - </b>'.$data["company_contact_no"].'</span>
				<br />
				<span style="font-size:16px;"><b>Email - </b>'.$data["company_email"].'</span>
				<br /><br />
			</td>
		</tr>	
		<tr>
				...
				<table width="100%" cellpadding="5">
					<tr>
						<td width="65%">
							...
							Name : '.$row["inventory_purchase_name"].'<br />	
							Address : '.$row["inventory_purchase_address"].'<br />
						</td>
						<td width="35%">							
							Order No. : '.$row["inventory_purchase_id"].'<br />
							Order Date : '.$row["inventory_purchase_date"].'<br />
						</td>
					</tr>
				</table>
				<br />
		...
		<tr >
			<td colspan="2" align="center" style="font-size:18px;border-top:none">
				<b>This is a machine generated invoice</b>
			</td>
		</tr>
	</table>
		';
	...
	$pdf = new Pdf();
	$file_name = 'purchase-'.$row["inventory_purchase_id"].'.pdf';
	$pdf->loadHtml($output);
