...
$row = $ims->getArray("inventory_".$table,"inventory_".$table."_id",$orderId);
...
$product_result =$ims->getAllArray("inventory_".$table."_product","inventory_".$table."_id",$orderId);
$count = 0;
$total = 0;
 $printtable = '<style>
.star img {
            ...
            <table align="left" cellpadding="0" cellspacing="0" class="w-100" >
               <tbody>
                  <tr class="border-dark" style="border-style: solid;border-width: thin;" >
                     <td>Bill No : '.$row["inventory_".$table."_id"].'</td>
                  </tr>
                  <tr>
...
foreach($product_result as $sub_row) {       
   ...
   $count++;
      ...
      <tr class="border-dark" style="border-bottom: 1px solid black;">
         ...
         <td  class="text-center border-dark" style="width: 218px; border-style: 1px solid; border-width: thin;  border-color: black; ">'.$row["inventory_".$table."_sub_total"].'</td>
      </tr>
      <tr>
         ...
         <td rowspan="2" class="text-center border-dark" style="border: 1px solid black;width: 288px;">'.$row["inventory_".$table."_discount"].'</td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td rowspan="2"  class="text-center border-dark" style="width:218px;border: 1px solid black;">'.$row["inventory_".$table."_tax"].'
         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td  class="text-center border-dark" style="border: 1px solid black;">'.$row["inventory_".$table."_total"].'</td>
      </tr>
      <tr>
